...
import ChatScreen from '../screens/chat/ChatDetailsScreen';
...
const MainStackNavigator = () => {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name={MAIN_STACK.PHRASEBOOK_LIST} component={PhrasebookListScreen}/>
      <Stack.Screen name={MAIN_STACK.ACCOUNT} component={ProfileScreen}/>
      <Stack.Screen name={MAIN_STACK.NOTIFICATION} component={NotificationScreen}/>
      <Stack.Screen name={MAIN_STACK.CHAT} component={ChatScreen}/>
    </Stack.Navigator>
  );
};
